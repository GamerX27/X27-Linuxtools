...
sudo apt update
sudo apt install -y curl htop cinnamon-core flatpak papirus-icon-theme synaptic distrobox pysassc build-essential xdg-user-dirs xdg-user-dirs-gtk make vlc eom
